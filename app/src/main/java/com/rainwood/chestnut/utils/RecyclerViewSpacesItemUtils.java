 ...
 */
public final class RecyclerViewSpacesItemUtils extends RecyclerView.ItemDecoration {
     ...
     */
    public RecyclerViewSpacesItemUtils(int bottomSpace) {
     ...
     * @param space      间距
     */
    public RecyclerViewSpacesItemUtils(@Decoration String decoration, int space) {
        switch (decoration) {
     ...
     * @param bottomSpace 下间距
     */
    public RecyclerViewSpacesItemUtils(int rightSpace, int topSpace, int leftSpace, int bottomSpace) {
